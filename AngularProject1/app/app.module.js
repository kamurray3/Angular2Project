    ...
    core_1.NgModule({
        imports: [
            ...
            router_1.RouterModule.forRoot([
                { path: 'products/:ProductCategoryCode', component: product_list_component_1.ProductListComponent },
                { path: 'products', component: product_list_component_1.ProductListComponent },
                { path: 'product/:ItemStyleNum', component: product_detail_component_1.ProductDetailComponent },
